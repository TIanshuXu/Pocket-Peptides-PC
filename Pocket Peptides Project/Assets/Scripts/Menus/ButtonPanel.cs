...
public class ButtonPanel : MonoBehaviour
{
    ...
    public void Submit()
    {
        if (dropZone.IsGoalAchieved)
        {
            ...
            am.Play("Victory");
            // use tutorial blocker to block other ui
            transform.Find("SubmitButton").SetSiblingIndex(3); // move it back
            transform.Find("Tutorial Blocker").gameObject.SetActive(true);
            GameObject.Find("Prompt Panels").transform.SetSiblingIndex(6);
        }
        else
        {
